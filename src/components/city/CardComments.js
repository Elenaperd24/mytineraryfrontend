...
function CardComments(props) {
    ...
    const submitComent = async (event) => {
        ...
        console.log(dataComments.message)
    ...
    return (
        <>
            <h3 className="text-lg" style={{ textAlign: "center" , fontFamily:"'Open Sans', sans-serif" }}>
                {comment?.length > 0 ? "Know opinions of our users" :
                    user ?
                        <div>
                            <p className="text-lg" style={{ textAlign: "center" , fontFamily:"'Open Sans', sans-serif" }}>Be the first to comment</p>
            ...
            <div className={comment?.length > 0 ? "comments shadow p-4 mt-2"  : "mt-2 commentsA p-4"}>
                {comment?.map((item) => {
                    return (
                        <Card className="w-11/12	mr-auto ml-auto	">
                            <CardHeader
                                avatar={
